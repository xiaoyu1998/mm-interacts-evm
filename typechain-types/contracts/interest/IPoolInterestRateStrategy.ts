...
export interface IPoolInterestRateStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): IPoolInterestRateStrategy;
  waitForDeployment(): Promise<this>;

  interface: IPoolInterestRateStrategyInterface;

...
export interface DepositHandlerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "dataStore"
      | "eventEmitter"
...
export interface DepositHandler extends BaseContract {
  connect(runner?: ContractRunner | null): DepositHandler;
  ...
  executeDeposit: TypedContractMethod<
    [account: AddressLike, depositParams: DepositUtils.DepositParamsStruct],
    [void],
    "nonpayable"
  >;

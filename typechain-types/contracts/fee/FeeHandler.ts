...
export interface FeeHandlerInterface extends Interface {
  getFunction(
    nameOrSignature: "claimFees" | "dataStore" | "eventEmitter" | "roleStore"
  ): FunctionFragment;
...
export interface FeeHandler extends BaseContract {
  ...
  claimFees: TypedContractMethod<[poolKeys: BytesLike[]], [void], "nonpayable">;
  ...
  ): TypedContractMethod<[poolKeys: BytesLike[]], [void], "nonpayable">;
  getFunction(
